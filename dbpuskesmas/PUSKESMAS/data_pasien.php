...
<body class="bg-gray-100 min-h-screen">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-10">
            <div class="mb-6">
                <h2 class="text-3xl font-semibold text-gray-800">Data Pasien</h2>
            </div>
                    ...
                    <tbody class="text-gray-700">
                        ...
                        foreach ($query as $row) {
                            echo "<tr class='border-b hover:bg-gray-50'>
                                    ...
                                    <td class='px-6 py-4'>
                                        <a href='form_pasien.php?id={$row['id']}' class='text-blue-600 hover:underline'>Ubah</a> |
                                        <a href='proses_pasien.php?idx={$row['id']}&proses=Hapus' class='text-red-600 hover:underline' onclick=\"return confirm('Yakin ingin menghapus?')\">Hapus</a>
                                    </td>
                                </tr>";
                            $nomor++;
                        }                        
