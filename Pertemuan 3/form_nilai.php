        ...
        <form method="post" action="" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <fieldset>
                ...
                <div class="mb-4">
                    ...
                    <input name="nama" type="text" placeholder="Masukan Nama" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="matkul">Mata Kuliah</label>
                    <select id="matkul" name="matkul" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                ...
                <div class="mb-4">
                    ...
                    <input id="nilai_uts" name="nilai_uts" type="text" placeholder="Masukan Nilai UTS" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nilai_uas">Nilai UAS</label>
                    <input id="nilai_uas" name="nilai_uas" type="text" placeholder="Masukan Nilai UAS" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="nilai_tugas">Nilai Tugas/Praktikum</label>
                    <input id="nilai_tugas" name="nilai_tugas" type="text" placeholder="Masukan Nilai Tugas" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
